...
- **WHEN** the frontend source files (`src/**/*.jsx`, `index.html`) are searched for the strings `admin123`, `admin999`, `示範帳號`, or `Demo:` followed by credentials
...
- **THEN** they MUST NOT contain the substrings `admin / admin123` or `admin / admin999`

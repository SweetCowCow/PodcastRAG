# show-mode-example-prompts Specification

## Purpose

TBD - created by archiving change 'per-show-mode-example-prompts'. Update Purpose after archive.
...
<!-- @trace
source: per-show-mode-example-prompts
updated: 2026-05-31
code:
  - docs/roadmap.md
  - skills-lock.json

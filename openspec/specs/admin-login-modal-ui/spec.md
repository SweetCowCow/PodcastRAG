...
- **THEN** no element inside the modal SHALL display the strings `admin123`, `示範帳號`, or `Demo:` followed by credentials
...
- **THEN** it MUST NOT contain the substring `admin / admin123`

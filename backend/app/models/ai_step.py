...
STEP_KEY_TO_TYPE: dict[StepKey, StepType] = {
    ...
    StepKey.asr_homophone: StepType.chat,
}
...
class AiStep(Base):
    ...
    __table_args__ = (
        CheckConstraint(
            "step_key IN ('answer', 'rewrite', 'summary', 'embedding', 'transcription', 'entity_extraction', 'asr_homophone')",

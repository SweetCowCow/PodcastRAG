...
> 最後更新：2026-06-02（EQ2b ✅、EQ2c ✅ 皆 archive。佇列＝EQ2d(F1+F2)→EQ2e(F6)→EQ3a–d→EQ4–7→EQ8(F4)/EQ9(F7)。**下一動＝propose EQ2d `asr-correction-reversibility-and-content-sync`（F6 前置鎖）**。執行佇列為權威排序，下方 Phase A–F 表為細節參考。）

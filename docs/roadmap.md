...
> 最後更新：2026-06-01（EQ1 favicon ✅ 上線；EQ2a asr-correction-dictionary proposal 完成並 parked（🔵），下一動＝`/spectra-apply asr-correction-dictionary`。執行佇列為權威排序，下方 Phase A–F 表為細節參考。）
